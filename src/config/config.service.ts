...
export class ConfigService {
  ...
  api = {
    ...
    cors: {
      origin: process.env.CORS_ORIGIN?.split(',') || ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', 'http://localhost:3003', 'https://hml.fazosimplesfc.app', 'https://fazosimplesfc.app'],
    },
  };
