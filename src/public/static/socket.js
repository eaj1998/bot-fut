...
!(function (t, n) {
  ...
  var nt =
    ...
    it = (function (t) {
      ...
      return (
        ...
        (r.doClose = function () {
          void 0 !== this.ws &&
            ((this.ws.onerror = function () {}), this.ws.close(), (this.ws = null));
        }),
        (r.uri = function () {
                      ...
                      transform: function (s, u) {
                        for (i.push(s); ; ) {
                          if (0 === r) {
                            ...
                            if (M(i) < 2) break;
                            var f = x(i, 2);
                            ((e = new DataView(f.buffer, f.byteOffset, f.length).getUint16(0)),
                              (r = 3));
                          } else if (2 === r) {
                            if (M(i) < 8) break;
                            var c = x(i, 8),
  ...
  function ft(t) {
    ...
    -1 != i &&
      -1 != r &&
      (t = t.substring(0, i) + t.substring(i, r).replace(/:/g, ';') + t.substring(r, t.length));
  ...
  var vt = (function (t) {
    function n(n, i) {
      ...
      return (
        ...
        (r.hostname =
          i.hostname || ('undefined' != typeof location ? location.hostname : 'localhost')),
        (r.port =
          i.port ||
